...
public class VendorControllerTest {
    ...
    public void getAllVendors() throws Exception{
        VendorListDTO vendorDTOS = new VendorListDTO(Arrays.asList(vendorDTO_1, vendorDTO_2));
    ...
    public void updateVendor() throws Exception{
        ...
        given(vendorService.saveVendorByDTO(anyLong(), any(VendorDTO.class))).willReturn(vendorDTO_2);
        ...
        mockMvc.perform(put(VendorController.BASE_URL + "/2")
                ...
                .andExpect(jsonPath("$.vendorUrl", equalTo(vendorDTO_2.getVendorUrl())));
    }
